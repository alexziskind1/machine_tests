#!/usr/bin/env python3
"""
Configuration loader for llama-bench benchmarking suite.
Follows the same schema pattern as the auto_prompter suite.
"""
...
def load_benchmark_config(config_path: str) -> BenchmarkConfigFull:
    ...
    target = TargetConfig(
        llama_bench_path=target_data["llama_bench_path"],
